...
from lib.operation.plotfigure import gridplot,grid_loglog_plot
...
gridplot(regret_2_bandit,list_T,label='2-BAN')
gridplot(regret_bandit,list_T,label='BAN')
gridplot(regret_gradient_c,list_T,label='OGD')
